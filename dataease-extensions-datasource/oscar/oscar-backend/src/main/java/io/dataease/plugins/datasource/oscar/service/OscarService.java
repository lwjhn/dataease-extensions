package io.dataease.plugins.datasource.oscar.service;
...
@Service
public class OscarService extends DatasourceService {
    ...
    public DataSourceType getDataSourceType() {
        DataSourceType dataSourceType = new DataSourceType("oscar", "oscar" , true , "", DatasourceCalculationMode.DIRECT, true);
    ...
    private StaticResource pluginSvg() {
        StaticResource staticResource = new StaticResource();
        staticResource.setName("oscar-backend");
