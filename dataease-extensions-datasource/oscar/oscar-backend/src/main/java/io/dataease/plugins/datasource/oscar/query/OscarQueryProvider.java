package io.dataease.plugins.datasource.oscar.query;
...
import io.dataease.plugins.datasource.oscar.provider.OscarConfig;
 ...
 */
@Component()
public class OscarQueryProvider extends QueryProvider {
    ...
    public String createRawQuerySQL(String table, List<DatasetTableField> fields, Datasource ds) {
        ...
        OscarConfig oscarConfig = new Gson().fromJson(ds.getConfiguration(), OscarConfig.class);
        return MessageFormat.format("SELECT {0} FROM {1}", StringUtils.join(array, ","),
                oscarConfig.getSchema() + ".\"" + table + "\"");
    }
